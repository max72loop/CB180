...
## 3. Pitch long (candidature à un programme précis, ex : BoursoBank, Fortuneo)
...
Je gère par ailleurs déjà des projets d'affiliation actifs (application ABO+, présente sur Awin), avec une bonne compréhension des exigences de conformité et de qualité des réseaux.

Je serais ravi d'échanger sur les modalités de partenariat. Bien cordialement, [Prénom Nom].

---

## 4. Liste des programmes à cibler par réseau

### Awin (priorité 1, compte existant)
- BoursoBank
- Fortuneo
- Hello bank!
- American Express France (programme Amex, souvent commissions élevées)
- Revolut (si présent, sinon direct)
- Vérifier aussi : Monabanq, BforBank

### Kwanko (priorité 2)
- Hello bank! / BNP (souvent présents)
- Programmes bancaires et néobanques du catalogue
- Cartes et comptes pro (Qonto, Shine) pour préparer l'angle B2B futur

### Effiliation (priorité 2)
- Monabanq (historiquement bien rémunéré ici)
- Autres banques de réseau et néobanques du catalogue

### En direct (priorité 3)
- Revolut : programme partenaires / Impact
- N26 : programme direct
- Vérifier les programmes propriétaires de chaque banque non couverte par les réseaux
...
- Noter chaque candidature dans un petit suivi (réseau, programme, date, statut) pour les relances de CA-013 et CA-020.

---

## 6. Mini tableau de suivi (à recopier dans ton Pixel Office ou un sheet)

| Réseau | Programme | Date candidature | Statut | Commission annoncée | Relance prévue |
|--------|-----------|------------------|--------|---------------------|----------------|
| Awin | BoursoBank | | en attente | | J+14 |
| Awin | Fortuneo | | en attente | | J+14 |
| Awin | Hello bank! | | en attente | | J+14 |
| Awin | Amex FR | | en attente | | J+14 |
| Kwanko | (à définir) | | | | |
| Effiliation | Monabanq | | | | |
| Direct | Revolut | | | | |
| Direct | N26 | | | | |

---

## 7. Rappel conformité (à ne pas oublier une fois validé)

Dès qu'un lien affilié est en ligne, les obligations du décret comparateurs et de la LCEN s'appliquent : mention du caractère publicitaire des liens, explication des critères de classement, information sur les relations commerciales avec les banques référencées. Ces éléments doivent être visibles avant la mise en ligne des premiers liens, pas après.
